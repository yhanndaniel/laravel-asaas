...
class CreatePaymentCreditCardRequest extends BaseRequest
{
    ...
    public array|CreditCardRequest $creditCard;
    public array|CreditCardHolderInfoRequest $creditCardHolderInfo;
    ...
    public function __construct(
        string $customer,
        BillingType $billingType = BillingType::CREDIT_CARD,
        float $value,
        string $dueDate,
        ?string $description,
        ...
        ?CreditCardHolderInfoRequest $creditCardHolderInfo,
        ...
        $this->creditCard = $creditCard->validated();
        $this->creditCardHolderInfo = $creditCardHolderInfo->validated();
    ...
    protected function validationRules($validationRules = [
        ...
        'creditCardToken' => 'nullable|string',
